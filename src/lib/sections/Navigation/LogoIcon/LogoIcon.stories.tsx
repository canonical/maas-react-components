...
const meta: Meta<typeof Navigation.LogoIcon> = {
  title: "Sections/Navigation/Logo/LogoIcon",
  component: Navigation.LogoIcon,
  render: (args) => (
    <Navigation.Logo>
      <Navigation.LogoTag>
        <Navigation.LogoIcon {...args} />
      </Navigation.LogoTag>
    </Navigation.Logo>
  ),
  tags: ["autodocs"],
...
export default meta;
export const Example = { args: { fill: "#fff", viewBox: "0 0 165.5 174.3", xmlns: "http://www.w3.org/2000/svg", children: (
  <>
